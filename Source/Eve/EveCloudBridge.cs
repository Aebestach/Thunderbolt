...
namespace Thunderbolt
{
    ...
    /// and precip/wetness densities ù not coverage alone.
    /// </summary>
    public static class EveCloudBridge
    {
        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                ThunderboltSettings.Log("EVE Atmosphere.dll linked ù cloud bridge ready.");
            }
            catch (Exception ex)
            {
                IsAvailable = false;
        ...
        private static float ComputeStormStrength(
            ...
            float relativeFreq)
        {
            // Mirror EVE ParticleField/WetSurfaces: coverage ù type density, with lightning weight.
